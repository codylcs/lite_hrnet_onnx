...
def parse_args():
    ...
    parser.add_argument('--config',
                        default="/home/cody/PycharmProjects/Lite-HRNet/configs/top_down/lite_hrnet/coco/litehrnet_30_coco_384x288.py",
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default="/home/cody/PycharmProjects/Lite-HRNet/weights/litehrnet_stem_32_s3_module_383_b2_fuse_reduce_8_w40_320_head_bs32_lr2e-3_aug_r30s25_val_gtbox_coco_384x288.pth",
                        # default="/home/cody/PycharmProjects/Lite-HRNet/tools/work_dirs/litehrnet_30_coco_384x288/best.pth",
                        help='checkpoint file')
    parser.add_argument('--show', action='store_true', help='show onnx graph')
    parser.add_argument('--output-file', type=str, default='lite_hr.onnx')
